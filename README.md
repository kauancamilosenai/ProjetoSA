...
Em caso do jogador acertar todas as letras exibirá uma tela de vitoria.

tera as variaveis: userInput, palavraSecreta, letras, contador de falhas, letras usadas

passo a passo:
jogador escolhe a palavra
jogador começa o jogo
Jogo começa
Jogador vai escolhendo as letras
caso contagem chegue em 0 = tela de derrota 
Quando digitar uma letra exibir a letra usada nas informações
